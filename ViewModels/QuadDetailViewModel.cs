...
{
    public class QuadDetailViewModel
    {
        ...
        public QuadDetailViewModel GetQuadDetails(int quadID)
        {
            HomeModel homeModel = new HomeModel();
            QuadDetailViewModel quadDetailViewModel = new QuadDetailViewModel();
            quadDetailViewModel.QuadID = quadID;
            quadDetailViewModel = homeModel.GetQuadDetail(quadDetailViewModel);
